		...
		<div class="container">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
					...
					<div class="logo">
        <a href="index.php">
            <img src="im/logo-no-background.png" width="230" height="50" class="auto-animated-logo"><br>
        </a>
    </div>
</div>
<style>
...
.auto-animated-logo {
    animation: logoAnimation 0.9s ease-in-out infinite; /* Animation lasts 3 seconds and repeats infinitely */
}
...
@keyframes logoAnimation {
    ...
    25% {
        transform: scale(1.1) rotate(5deg); /* Slightly scale up and rotate */
    }
    50% {
        transform: scale(1) rotate(0deg); /* Return to normal */
    }
    75% {
        transform: scale(1.1) rotate(-5deg); /* Slightly scale up and rotate in the opposite direction */
    }
    100% {
        transform: scale(1) rotate(0deg); /* Return to normal */
    }
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price">GH&#8373<?php echo ($row['productPrice']+$row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total :</span><span class='price'>GH&#8373<?php echo $_SESSION['tp']="$totalprice". ".000"; ?></span>
