...
?>
				...
				<tr>
					<td class="col-md-2"><img src="admin/productimages/<?php echo htmlentities($row['pid']);?>/<?php echo htmlentities($row['pimage']);?>" alt="<?php echo htmlentities($row['pname']);?>" width="110" height="130"></td>
					<td class="col-md-6">
...
?>
						...
						<?php } ?>
						<div class="price">GH&#8373
							<?php echo htmlentities($row['pprice']);?>.000
							<span>GH&#8373900.000</span>
						</div>
					</td>
					<td class="col-md-2">
