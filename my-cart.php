...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "GH&#8373"." ".$row['productPrice']; ?>.000</span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "GH&#8373"." ".$row['shippingCharge']; ?>.000</span></td>
